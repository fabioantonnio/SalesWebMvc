...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "John Leemon", "johnleemon@gamil.com", new DateTime(1998, 4, 21), 1110.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "mariagreen@gamil.com", new DateTime(1979, 3, 2), 2200.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alexgrey@gamil.com", new DateTime(1999, 5, 18), 1000.0, d3);
            Seller s4 = new Seller(4, "Martha Red", "marthared@gamil.com", new DateTime(1985, 3, 1), 1700.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "bluedonald@gamil.com", new DateTime(1983, 3, 15), 1340.0, d4);
            Seller s6 = new Seller(6, "Alexander Pink", "pink.xander@gamil.com", new DateTime(1956, 8, 10), 2440.0, d3);
            Seller s7 = new Seller(7, "Ian Brown", "ianbrown365@gamil.com", new DateTime(1965, 6, 3), 2000.0, d1);
            Seller s8 = new Seller(8, "Mcalister Grey", "mcgrey@gamil.com", new DateTime(2001, 4, 5), 1760.0, d2);
            Seller s9 = new Seller(9, "Johnny Cash", "jonnybille@gamil.com", new DateTime(1989, 10, 7), 1650.0, d4);
            Seller s10 = new Seller(10, "Atixa Vaney", "avaneyla@gamil.com", new DateTime(1997, 8, 20), 1440.0, d3);
            ...
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6, s7, s8, s9, s9, s10);
